Shader "koturn/SphereTracingTips/05_Texture/Triplanar"
{
    Properties
    {
        // ------------------------------------------------------------
        ...
        _TriplanarSharpness ("Sharpness of Truplanar", Range(1.0, 64.0)) = 1.0
    ...
    SubShader
    {
        ...
        fout frag(v2f fi)
        {
            ...
            half4 color = tex2DTriPlanar(_MainTex, worldFinalPos, worldNormal, _TriplanarSharpness) * _Color;
        #else
            ...
            half4 color = tex2DTriPlanar(_MainTex, localFinalPos, localNormal, _TriplanarSharpness) * _Color;
        #endif  // defined(_CALCSPACE_WORLD)
