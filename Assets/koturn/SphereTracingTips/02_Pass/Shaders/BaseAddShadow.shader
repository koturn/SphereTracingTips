Shader "koturn/SphereTracingTips/02_Pass/BaseAddShadow"
{
    Properties
    {
        // ------------------------------------------------------------
    ...
    SubShader
    {
        ...
        #if defined(_SVDEPTH_ON) && (!defined(UNITY_PASS_SHADOWCASTER) || !defined(SHADOWS_CUBE) || defined(SHADOWS_CUBE_IN_DEPTH_TEX))
            //! Depth of the pixel.
            float depth : SV_Depth;
        #endif  // defined(_SVDEPTH_ON) && (!defined(UNITY_PASS_SHADOWCASTER) || !defined(SHADOWS_CUBE) || defined(SHADOWS_CUBE_IN_DEPTH_TEX))
        };
